...
public class Scene extends SScene {
    ...
    public PlayingCard determinePlayingCard (int num){
        switch (num) {
            case 1:  return playingCard1;
            case 2:  return playingCard2;
            case 3:  return playingCard3;
            case 4:  return playingCard4;
            case 5:  return playingCard5;
            case 6:  return playingCard6;
            case 7:  return playingCard7;
            case 8:  return playingCard8;
            case 9:  return playingCard9;
            case 10: return playingCard10;      
            default: return playingCard1;
        }
    }
    ...
    public void displayWinner(final TextModel winSign, final TextModel scoreSign,
        ...
        /*do in order*/ {//display winner
            winSign.setOpacity(1.0, SetOpacity.duration(1.0));
            winSign.setOpacity(0.0, SetOpacity.duration(1.0));
            winSign.setOpacity(1.0, SetOpacity.duration(1.0));
            winSign.setOpacity(0.0, SetOpacity.duration(1.0));
            winSign.setOpacity(1.0, SetOpacity.duration(1.0));
            winSign.setOpacity(0.0, SetOpacity.duration(1.0));
